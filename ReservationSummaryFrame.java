...
public class ReservationSummaryFrame extends JFrame {
    ...
    public ReservationSummaryFrame(String purpose_, String date_, String time_) {
        ...
        String note_2 = ("Secure a copy by taking a screenshot or saving this. Present this at the registrar to avoid waiting in line.");
        ...
        save.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                     String reservation = "STUDENT ID: " + studentId + " | NAME: " + name + " | DEPARTMENT: " + dept + " | YEAR: " + year +
                            " | PURPOSE: " + purpose_ + " | SCHEDULED DATE: " + date_ + " | SCHEDULED TIME: " + time_ +
                            " | DATE: " + formattedDate;
                    
                    reservationQueue.enqueue(reservation);
                    
                    saveReservationsToFile(reservationQueue);
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(null, "Error saving reservation: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
    ...
    private static void saveReservationsToFile(ReservationQueue reservationQueue) throws IOException {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("List.txt"))) {
            while (!reservationQueue.isEmpty()) {
                String reservation = reservationQueue.dequeue();
