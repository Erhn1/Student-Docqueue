...
public class HomeFrame extends JFrame implements ActionListener {
    ...
    HomeFrame(String title) {
        ...
        image = logo.getImage();
        resizedImage = image.getScaledInstance(85, 70, java.awt.Image.SCALE_SMOOTH);
        ...
        registration = new JButton("LOG-IN");
        ...
        registration.setPreferredSize(new Dimension(105, 80));
